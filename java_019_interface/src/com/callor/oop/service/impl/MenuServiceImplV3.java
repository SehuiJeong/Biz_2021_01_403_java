...
public class MenuServiceImplV3 implements MenuService {
	...
	public MenuServiceImplV3() { // 여기는 void나 int나 String같은 거 안 넣음, 그리고 class와 이름이 같아야 한다.
		scan = new Scanner(System.in);
	}

	/*
	 * 메뉴를 보여주고
	 * 선택된 메뉴에 따라 카트에 추가, 삭제 하거나 리스트를 보여줘야 한다
	 * 이 기능을 MenuService에서 구현하는 것이 아니라
	 * selcetMenu()를 호출한 곳에서 구현을 해야 한다.
	 * 
	 ...
	 * 		void type이 아닌 int나 String 등 다른 type으로 변경해야 한다.
	 * 		클래스의 method를 변경하려면
	 * 		interface부터 변경하고, interface를 impl...한
	 * 		모든 클래스를 다 변경해야 한다.
	 * 
