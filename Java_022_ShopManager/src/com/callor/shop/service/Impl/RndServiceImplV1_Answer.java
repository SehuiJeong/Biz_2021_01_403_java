...
public class RndServiceImplV1_Answer {

	// makeRnd()와 saveFileRnd() method가 공용으로
	// 사용할 객체이므로 인스턴스 객체변수로 선언
	private List<Integer> intList;
	public RndServiceImplV1_Answer() {
	...
	/*
	 * RndServiceImplV1 클래스를 처음 디자인할 때는
	 ...
	 * 
	 * 이제는 saveFileRnd(), saveFileRnd(파일이름) 두가지 중
	 * 어떤 것이든 호출하여 사용해도 문제가 없다
	 */
	 ...
	 * 연산을 수행하는 method
	 * 
	 * 저장할 때 사용한 파일 이름 == 읽을 때 사용할 파일이름
	 * 
	 * 이 상황은 2개의 method가 1개의 공통된 파일이름을 사용한다는 것이다
	 * 
	 * 결국 saveFileRnd() method만 사용하기 위해 선언된 
