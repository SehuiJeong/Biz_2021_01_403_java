...
/*
 * List 클래스
 * 배열(Array)의 단점을 보완하기 위해서 java의 JDK에 포함되어 있는
 * 데이터리스트를 관리하기 위한 클래스
 * 
 * 1. 데이터(값)들을 다량으로 저장하는 용도의 객체 생성
 * 2. 배열을 선언하여 값을 저장하는 것과 비슷한 용도
 * 3. 처음에 생성할 때 몇 개의 데이터를 저장할지 결정하지 않고
...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		// 정수형으로 저장하겠다고 int형을 썼는데 문자열이나 float형을 쓰면 오류가 나지
		// 이게 배열의 단점 : 처음에 type을 설정하면 중간에 절대 변경 불가능
				
		
		// 공통 타입의 ArrayList 객체 생성
